...
public class Accounts extends JFrame {
    ...
    private static final String ROLE = "accountant";
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel logoLabel = new JLabel(new ImageIcon("images/accounts.png"));
            ...
            if (!newDescription.isEmpty()) {
                try (Connection connection = DriverManager.getConnection(
                    ...
                    try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                        ...
                        if (rowsUpdated > 0) {
                            JOptionPane.showMessageDialog(Accounts.this, "Task ID: " + taskId + " updated successfully.");
                            displayTasks();
                        } else {
                            JOptionPane.showMessageDialog(Accounts.this, "Failed to update Task ID: " + taskId);
                        }
                    }
                } catch (SQLException ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(Accounts.this, "An error occurred while updating Task ID: " + taskId);
                }
            } else {
                JOptionPane.showMessageDialog(Accounts.this, "Please enter a valid description.");
            }
        }
    }
        ...
        if (confirmResult == JOptionPane.YES_OPTION) {
            try (Connection connection = DriverManager.getConnection(
                ...
                try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
                    ...
                    if (rowsDeleted > 0) {
                        JOptionPane.showMessageDialog(Accounts.this, "Task ID: " + taskId + " deleted successfully.");
                        displayTasks();
                    } else {
                        JOptionPane.showMessageDialog(Accounts.this, "Failed to delete Task ID: " + taskId);
                    }
                }
            } catch (SQLException ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(Accounts.this, "An error occurred while deleting Task ID: " + taskId);
            }
        }
    }
